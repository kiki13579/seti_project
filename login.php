<?php
// Afficher un message d'erreur si l'URL contient ?error=...
$error_message = '';
if (isset($_GET['error'])) {
    switch ($_GET['error']) {
...
<head>
    ...
    <title>Connexion - Projet SETI</title>
    <style>
        /* --- Style de base --- */
        body {
...
<body>
    ...
    <!-- Le formulaire de connexion est maintenant le contenu principal -->
    <div class="login-container">
        <h2>Accès Back-Office</h2>
        <form action="api/auth/login_verification.php" method="POST">
